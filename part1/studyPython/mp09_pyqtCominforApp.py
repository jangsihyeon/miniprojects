...
class qtApp(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon('./studyPython/setting.png'))
    ...
    def initInfo(self):
        ...
        for disk in disks:
            if disk.fstype =='NTFS':
                ...
                msg = f'{disk.mountpoint} {disk.fstype} - {du_total}'
        ...
        out_addr = req.text[req.text.find('<font color=red>'):req.text.find('</font><br>')]
