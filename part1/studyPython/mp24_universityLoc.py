...
df_excel.columns=['학교명', '주소', 'lng', 'lat']     # lng = 위도 , lat 경도 
...
fMap = folium.Map(lacation=[37.553175, 126.989326], zoom_start= 10)

for i in range(len(name_list)): # 446 반복
    if lng_list[i] != 0:        # 위, 경도 값이 0 이면 출력 x 
